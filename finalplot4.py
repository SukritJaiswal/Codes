...
file_55=np.loadtxt("/home/sukrit/Desktop/Combine Code/pmode_l2_m0.55_2.out")
nb_55=file_55[:,0] 
r55=file_55[:,1]
m55=file_55[:,2]
f55=file_55[:,3]
...
plt.plot(r55,m55,'-',label=r'$m^*=0.55m_N$')
plt.plot(r60,m60,'-',label=r'$m^*=0.60m_N$')
plt.plot(r65,m65,'-',label=r'$m^*=0.65m_N$')
plt.plot(r70,m70,'-',label=r'$m^*=0.70m_N$')
plt.plot(r75,m75,'-',label=r'$m^*=0.75m_N$')
...
plt.show()
fig.savefig("massvsradius_effm_1.pdf",dpi=600)
...
plt.legend(fontsize = 16)
plt.show()
fig.savefig("massvsfreq_effm_1.pdf",dpi=600)
...
plt.legend(fontsize = 16)
plt.show()
fig.savefig("wMvscompactness_effm_1.pdf",dpi=600)
...
plt.legend(fontsize = 16)
plt.show()
fig.savefig("densityvsfreq_effm_1.pdf",dpi=600)
