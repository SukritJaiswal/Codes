...
file_55=np.loadtxt("/home/sukrit/Desktop/Combine Code/fmode_lowmass_0.55.out")
nb_55=file_55[:,0] 
r55=file_55[:,1]
m55=file_55[:,2]
f55=file_55[:,3]
...
file_60=np.loadtxt("/home/sukrit/Desktop/Combine Code/fmode_lowmass_0.60.out")
...
file_65=np.loadtxt("/home/sukrit/Desktop/Combine Code/fmode_lowmass_0.65.out")
nb_65=file_65[:,0] 
r65=file_65[:,1]
m65=file_65[:,2]
f65=file_65[:,3]
...
file_70=np.loadtxt("/home/sukrit/Desktop/Combine Code/fmode_lowmass_0.70.out")
nb_70=file_70[:,0] 
r70=file_70[:,1]
m70=file_70[:,2]
f70=file_70[:,3]
...
file_75=np.loadtxt("/home/sukrit/Desktop/Combine Code/fmode_lowmass_0.75.out")
nb_75=file_75[:,0] 
r75=file_75[:,1]
m75=file_75[:,2]
f75=file_75[:,3]
...
plt.ylim(0.5,1.7)
plt.show()
fig.savefig("massvsfreq_lowmass_effm_1.pdf",dpi=600)
...
plt.legend(fontsize = 16)
plt.show()
fig.savefig("wMvscompactness_lowmass_effm.pdf",dpi=600)
...
plt.legend(fontsize = 16)
plt.show()
fig.savefig("densityvsfreq_lowmass_effm.pdf",dpi=600)
