...
#define hc1 197.32
#define rmp 939.0   // avg mass of nucleon in nucleus
...
#define rmsig  550.00   // mass of sigma meson
#define rmome  783.00   // mass of omega meson
#define rmrho  763.0   // mass of rho meson
...
// read input parameters from input file
 fin=fopen("calccoup_isovec.in","r");
